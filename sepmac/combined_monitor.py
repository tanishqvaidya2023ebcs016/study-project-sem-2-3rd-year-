"""
Combined LPM + RTT Monitor
Single dashboard showing both metrics side by side.

Run on Mac:
    QUEUE_SERVER=localhost:50051 FILE_SERVER=100.x.x.2:50052 python monitor/combined_monitor.py

Run on Windows:
    set QUEUE_SERVER=100.x.x.1:50051
    set FILE_SERVER=localhost:50052
    python monitor/combined_monitor.py
"""
